...
RESOURCE RULE: Use the exact book references above in the "resource" field — do not invent other books.`;
        ...
        if (failedSubjectsList.includes('physics')) {
            hinglishExample = `"Dekh ${studentName}, tera Electromagnetic Induction bilkul toot gaya — 2 mein se 2 galat. Aaj raat sirf ek kaam karo: HC Verma Chapter 38 ke examples 38.1 se 38.4 tak padho, phir book band karke flux change ki derivation apne haath se likho. Ek baar ye samajh gaya toh NEET mein EMI ke 2 questions pakka milenge."`;
        } else if (failedSubjectsList.includes('chemistry')) {
            hinglishExample = `"${studentName}, tera Chemical Bonding wala part dekha — Q16 mein tune Micro aur Milli confuse kar diya, ye memory gap hai. Aaj raat NCERT Class XI Chemistry Chapter 4 Section 4.3 padho, phir ek table bana — hybridization types aur unke examples. Kal mujhe 5 examples sunana bina book dekhe."`;
            ...
            hinglishExample = `"Dekh ${studentName}, aaj ka paper dekha — kuch gaps hain but sab fixable hai. Is hafte priority list ke hisaab se chalte hain."`;
        }
